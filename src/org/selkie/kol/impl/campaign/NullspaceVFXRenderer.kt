...
class NullspaceVFXRenderer : LunaCampaignRenderingPlugin {
    ...
    @Transient
    var vignette = Global.getSettings().getSprite("graphics/fx/kol_darkness_vignette.png")
    ...
    override fun render(layer: CampaignEngineLayers?, viewport: ViewportAPI?) {
        if (vignette == null) {
            vignette = Global.getSettings().getSprite("graphics/fx/kol_darkness_vignette.png")
        }
