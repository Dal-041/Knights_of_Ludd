...
import org.selkie.kol.impl.campaign.interactions.LunaHypershuntInteraction;

public class KOLCampaignPlugin extends BaseCampaignPlugin {
    ...
    public PluginPick<InteractionDialogPlugin> pickInteractionDialogPlugin(SectorEntityToken interactionTarget) {
        ...
        if (interactionTarget.getCustomEntitySpec() != null) {
            ...
            if (spec.getId().equals("zea_edf_coronal_tap")) return new PluginPick<InteractionDialogPlugin>(new LunaHypershuntInteraction(), PickPriority.HIGHEST);
        }
