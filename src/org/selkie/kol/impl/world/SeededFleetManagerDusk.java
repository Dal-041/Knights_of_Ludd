...
public class SeededFleetManagerDusk extends SeededFleetManager {
    ...
    public SeededFleetManagerDusk(StarSystemAPI system, int minFleets, int maxFleets, int minPts, int maxPts, float activeChance) {
        super(system, 1f);
        this.minPts = minPts;
        this.maxPts = maxPts;
    ...
    protected CampaignFleetAPI spawnFleet(long seed) {
        ...
        FleetParamsV3 params = new FleetParamsV3(
                ...
                MathUtils.getRandomNumberInRange(minPts*factorMain, maxPts*factorMain), // combatPts
                0f, // freighterPts
                0f, // tankerPts
                0f, // transportPts
                0f, // linerPts
