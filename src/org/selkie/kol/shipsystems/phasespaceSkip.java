...
import org.selkie.kol.plugins.KOL_FakeSmokePlugin;
...
public class phasespaceSkip extends BaseShipSystemScript {
  ...
  public void apply(MutableShipStatsAPI stats, String id, ShipSystemStatsScript.State state, float effectLevel) {
    ...
    for (int i = 0; i < 900.0F * amount; i++) {
      ...
      KOL_FakeSmokePlugin.addFakeSmoke(MathUtils.getRandomNumberInRange(0.32F, 0.68F), MathUtils.getRandomNumberInRange(55.0F, 75.0F), pointToSpawnAt, MathUtils.getRandomPointInCircle(null, 10.0F), MathUtils.getRandomNumberInRange(-15.0F, 15.0F), 0.85F, new Color(0.0F, 0.0F, 0.0F));
    } 
  }
