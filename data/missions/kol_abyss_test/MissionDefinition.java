package data.missions.kol_abyss_test;
...
public class MissionDefinition implements MissionDefinitionPlugin {
	...
	public void defineMission(MissionDefinitionAPI api) {
		...
		api.initFleet(FleetSide.PLAYER, "DOM", FleetGoal.ATTACK, false);
		api.initFleet(FleetSide.ENEMY, "KOL", FleetGoal.ATTACK, true);
...
//		api.getDefaultCommander(FleetSide.PLAYER).getStats().setSkillLevel(Skills.ELECTRONIC_WARFARE, 3);
		...
		api.setFleetTagline(FleetSide.PLAYER, "Forces of Moloch");
		api.setFleetTagline(FleetSide.ENEMY, "Knights of Ludd");
